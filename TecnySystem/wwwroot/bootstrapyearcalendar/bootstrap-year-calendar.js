...
(function ($) {
    ...
    Calendar.prototype = {
        ...
        _renderBody: function () {
            ...
            monthsDiv.addClass('months-container row');
        ...
        _renderDataSourceDay: function (elt, currentDate, events) {
            switch (this.options.style) {
                ...
                case 'background':
                    ...
                    //console.log(events[events.length - 1].color + " - " + [events.length]);
        ...
        _applyEvents: function () {
            ...
            setInterval(function () {
                ...
                if (monthSize * 6 < calendarSize) {
                    monthContainerClass += ' col-xs-2 col-sm-3';
                }
                else if (monthSize * 4 < calendarSize) {
                    monthContainerClass += ' col-xs-3 col-sm-3';
                }
                else if (monthSize * 3 < calendarSize) {
                    monthContainerClass += ' col-xs-4 col-sm-3';
                }
                else if (monthSize * 2 < calendarSize) {
                    monthContainerClass += ' col-xs-6 col-sm-3';
                }
                else {
                    monthContainerClass += ' col-xs-12 col-sm-3';
                }
    ...
    //Colores
    //var colors = $.fn.calendar.colors = ['#2C8FC9', '#9CB703', '#F5BB00', '#FF4A32', '#B56CE2', '#45A597']; COLORES ALEATORIOS
    //var colors = $.fn.calendar.colors = ['#ed1a3b', '#df8639', '#98002e', '#218f8b', '#02a5e2', '#657c91']; COLORES BDO
    var colors = $.fn.calendar.colors = ['#ed1a3bb3', '#df8639ba', '#98002e87', '#218f8bab', '#02a5e2b0', '#657c91a8'];
    //var colors = $.fn.calendar.colors = ['#ed1a3bb3', '#df8639ba'];
