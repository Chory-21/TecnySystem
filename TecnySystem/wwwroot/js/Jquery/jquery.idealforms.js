(function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
        ...
        module.exports = {
            ...
            name: 'Debe tener entre 4 y 32 caracteres y contener solo letras.',
            email: 'Debe ser un correo electrónico válido',
            username: 'Debe tener entre 4 y 32 caracteres y contener solo letras',
            pass: 'Must be at least 6 characters long, and contain at least one number, one uppercase and one lowercase letter',
            strongpass: 'Debe tener al menos 8 caracteres y contener al menos una letra mayúscula y una letra minúscula y un número o un carácter especial',
            ...
            equalto: 'Debe tener el mismo valor que {0}',
        ...
        module.exports = {
            ...
            methods: {
                ...
                _init: function () {
                    ...
                    $.idealforms.errors.ajax = $.idealforms.errors.ajax || 'Cargando...';
      ...
      '
        ...
        */
        ...
        module.exports = {
            ...
            _validate: function (input, handleError, handleStyle) {
                ...
                if (input.id == "txtNewPassword") {
                    ...
                    if (valid == true) {
                        console.log("hola");
                        document.getElementById("txtConfirmNewPassword").readOnly = false;
                        document.getElementById("txtAlertaRegistrarse").style.display = "none";
                        document.getElementById("btnCambiarClave").style.display = "block";
                    } else {
                        //document.getElementById("txtConfirmNewPassword").innerHTML("readonly", "true");
                        document.getElementById("txtConfirmNewPassword").readOnly = true;
                        document.getElementById("btnCambiarClave").style.display = "none";
                        document.getElementById("txtAlertaRegistrarse").style.display = "block";
                    };
                };
                ...
                if (input.id == "txtClave") {
                    ...
                    if (valid == true) {
                        console.log("hola");
                        //document.getElementById("txtConfirmNewPassword").innerHTML("readonly", "false");
                        document.getElementById("txtConfirmClave").readOnly = false;
                        document.getElementById("txtAlertaRegistrarse").style.display = "none";
                        document.getElementById("btnRegistrar").style.display = "block";
                    } else {
                        //document.getElementById("txtConfirmNewPassword").innerHTML("readonly", "true");
                        document.getElementById("txtConfirmClave").readOnly = true;
                        document.getElementById("btnRegistrar").style.display = "none";
                        document.getElementById("txtAlertaRegistrarse").style.display = "block";
                    };
                };

                //DANIEL ESTA PROBANDO ESTO
                if (input.id == "txtNewPassword2") {
                    console.log(rule);
                    console.log(valid);
                    console.log(input.id);
        ...
        module.exports = {
            ...
            digits: /^\d+$/,
            //name: /^[a-zA-Z ]*$/,
            name: /^([a-z-ñáéíóú-\s]{3,60})$/i,
            //name: /^[a-zA-ZÀ-ÿu00f1u00d1 ]$/,
            email: /^[^@]+@[^@]+\..{2,6}$/,
            //username: /^[a-z](?=[\w.]{3,31}$)\w*\.?\w*$/i,
            username: /^[\u00F1A-Za-z _]*[\u00F1A-Za-z][\u00F1A-Za-z _]*$/,
            pass: /(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}/,
            //strongpass: /(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/,
            //strongpass: /(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/,
            //strongpass: /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#@.,;:_$!&+*/<=>-])(?!.*?[ ]).{8,}$/,
            //strongpass: /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[@.,;:_$!<>])(?!.*?[ ]).{8,}$/,
            strongpass: /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[@.,;:_$!])(?!.*?[ ]).{8,}$/,
